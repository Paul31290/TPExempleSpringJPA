...
public class CountryRepositoryTest {
    ...
    void testPopulationPays() {
        ...
        City Toulouse = new City("Toulouse", FR);
        Toulouse.setPopulation(4);
        assertEquals(countryDAO.PopulationPays(1), 12 + 4, "On doit trouver 16 millions" );
    }
    /*
    @Test
    @Sql("test-data.sql") // On peut charger des donnnées spécifiques pour un test
    void testlistPays() {
        ...
        assertTrue(countryDAO.listPays()
    */
}
